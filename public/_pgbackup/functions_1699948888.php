...
if ( ! function_exists( 'ohoho_components_app_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'ohoho_components_app-app', get_template_directory_uri() . '/app.js', [], '1.0.8', true);
    ...
    wp_enqueue_style( 'ohoho_components_app-styles', get_template_directory_uri() . '/styles.css', [], '1.0.8', 'all');

    wp_deregister_style( 'ohoho_components_app-style' );
    wp_enqueue_style( 'ohoho_components_app-style', get_bloginfo('stylesheet_url'), [], '1.0.8', 'all');
